...
return array(
   ...
   // 预先加载的标签库
    'TAGLIB_PRE_LOAD'     =>    'OT\\TagLib\\Article,OT\\TagLib\\Member,OT\\TagLib\\Tags,OT\\TagLib\\Focus',
    'LOAD_EXT_CONFIG' => 'theme,url,route',
    /* 数据缓存设置 */
    'DATA_CACHE_PREFIX' => 'cs111_', // 缓存前缀
    'DATA_CACHE_TYPE'   => 'File', // 数据缓存类型
    'VIEW_PATH'=>'./Theme/',

    /* SESSION 和 COOKIE 配置 */
    'SESSION_PREFIX' => 'cs_home', //session前缀
    'COOKIE_PREFIX'  => 'cs_home_', // Cookie前缀 避免冲突
