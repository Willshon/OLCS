...
-- -----------------------------
INSERT INTO `cs_message` VALUES ('1', '0', '500', '注册成功', '恭喜您！您已经注册成功，请尽快<a href=\"/cs/index.php/Ucenter/yzmail.shtml\">验证邮箱地址</a>,第一时间获取网站动态！', '1423356722', '0', '1', '1');
INSERT INTO `cs_message` VALUES ('2', '0', '501', '注册成功', '恭喜您！您已经注册成功，请尽快<a href=\"/cs/index.php?m=&c=Ucenter&a=yzmail\">验证邮箱地址</a>,第一时间获取网站动态！', '1423362955', '0', '1', '1');
...
CREATE TABLE `cs_subject` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='专业表';
...
INSERT INTO `cs_teacher` VALUES ('504', '', '未命名', '男', '', '群众', '', '', '', '', '学士', '讲师', '', '1', '1');
...
CREATE TABLE `cs_score` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='成绩表';

-- -----------------------------
-- Records of `cs_score`
-- -----------------------------
INSERT INTO `cs_score` VALUES ('1', '1', '1', '15', '1');
INSERT INTO `cs_score` VALUES ('9', '505', '2', '', '1');
INSERT INTO `cs_score` VALUES ('10', '505', '1', '', '1');
...
-- -----------------------------
INSERT INTO `cs_ucenter_member` VALUES ('1', 'admin', '79234378722acf17ccee37e9cf7156ab', '291669020@qq.com', '', '1423355260', '0', '1427091892', '0', '1427007925', '1');
...
INSERT INTO `cs_ucenter_member` VALUES ('505', 'student', 'c112a8a27b148e8c64edfb94a8b3de18', '12345@qq.com', '0', '1423968241', '0', '1426206632', '0', '1427011180', '1');
...
-- -----------------------------
INSERT INTO `cs_member` VALUES ('1', 'admin', '王硕', '0', '0000-00-00', '', '0', '81', '0', '1423355260', '0', '1427091892', '1', '', '0', '0', '0', '0', '0');
...
INSERT INTO `cs_member` VALUES ('505', 'Willshon', '王硕', '0', '0000-00-00', '', '0', '8', '0', '1423968241', '0', '1426206632', '1', '快乐就好!', '0', '0', '0', '0', '0');
...
INSERT INTO `cs_student` VALUES ('504', '6111010104', '王硕', '1', '王琳', '', '', '1');
INSERT INTO `cs_student` VALUES ('505', '6111010110', '王硕', '1', '王琳', '', '', '1');
INSERT INTO `cs_student` VALUES ('502', '6111010105', '王硕', '', '', '', '', '1');
