    ...
    <div class="panel panel-default panel-archive">
        <div class="panel-body">
            ...
            <ul class=" nav nav-pills pb10 mb10 mt10">
                <li class="active"><a href="<?php echo CSU('/course/','Index/course');?>">已选课程</a></li>
                <?php if(is_array($coursed)): $i = 0; $__LIST__ = $coursed;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a><?php echo (getNameById('course',$vo["couid"])); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
            <div style="min-height:300px;">
                <form action="<?php echo U('index/course');?>" method="post" id="formsearch">
                ...
                <table class="dataTable table text-left"  id="dataTables">
                    ...
                    <tbody>
                        <?php if(is_array($course)): $i = 0; $__LIST__ = $course;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td><?php echo ($vo['id']); ?></td>
                                <td><?php echo ($vo['name']); ?></td>
                                <td><?php echo (getNameById('teacher',$vo['teaid'])); ?></td>
                                <td><?php echo (getNameById('subject',$vo['subid'])); ?></td>
                                <td><?php echo ($vo['xuefen']); ?></td>
                                <td>
                                    <?php echo (showCourseStatus($vo['id'])); ?>
                                </td>
