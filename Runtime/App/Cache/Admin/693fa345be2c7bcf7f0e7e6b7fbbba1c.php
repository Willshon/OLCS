...
<div id="page-content">
    ...
    <form action="/cs/index.php/Admin/Cate/update" id="j_custom_form" url="<?php echo U('Cate/index');?>" callback="TabAjaxDone" class="col-md-12 form-label-right center-margin form-validate" method="post" noEnter>
       ...
       <div class="pageContainer">
           ...
           <div class="form-row">
               ...
               <select name="status"  data-container="body"  id="j_status" class="selectpicker show-tick validate[required]" data-style="btn medium bg-green" data-width="auto">
                 ...
                 <div class="form-row">
                <div class="form-label col-md-2"><label>学生权限：</label>
                </div>
                <div class="col-md-7">
               <select name="enable"  data-container="body"  id="j_enable" class="selectpicker show-tick" data-style="btn medium bg-green" data-width="auto">
                                 ...
                                 <option <?php if(($info["enable"]) == "1"): ?>selected<?php endif; ?> value="1">学生可发布</option>
                                <option <?php if(($info["enable"]) == "0"): ?>selected<?php endif; ?> value="0">学生禁止发布</option>
                 </select>
            </div></div>
           <div class="form-row">
...
<div class="col-md-7">
					...
					<div class="upload-img-box">
						...
						<img src="/cs<?php echo ($info["path"]); ?>" width="100" height="100"/></div><?php endif; ?>
					</div>
...
$(function(){
	...
	$("#upload_picture_advspic").uploadify({
        "height"          : 30,
        "swf"             : "/cs/Public/static/uploadify/uploadify.swf",
        "fileObjName"     : "Picture",
