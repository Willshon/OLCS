...
<div id="page-breadcrumb-wrapper">
                        ...
                        <div id="page-breadcrumb">
                            <a href="javascript:;" id="parentname" title="扩展管理">
                                <i class="glyph-icon icon-dashboard"></i>
                                扩展管理
                            </a>
...
<form  id="formsearch" action="<?php echo cookie('_currentUrl_');?>" method="post">
...
<?php if(empty($custom_adminlist)): ?><table class="table text-left"  id="zstable">
     	<thead>
					<tr>
						<th>
						 	序号
