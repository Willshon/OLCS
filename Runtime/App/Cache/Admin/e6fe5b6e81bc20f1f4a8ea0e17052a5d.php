...
<div id="page-content">
	...
	<form action="<?php echo U('index');?>" method="post" id="formsearch">
        <div class="example-code">
            ...
            <a href="<?php echo U('add');?>" target="dialog" rel="facultyadd" title="新增院系" width="500px" height="280px" class="btn medium bg-green"><span class="button-content">
                <i class="glyph-icon icon-plus"></i>新增</span>
            </a>
            ...
            <div class="dropdown float-right mrg15R">
                ...
                <ul class="dropdown-menu float-right">
                    ...
                    <li class="hidden">
                        <a href="/cs/index.php/Admin/Faculty/outxls/ids/all" target="dwzExport">
                            <i class="glyph-icon icon-sign-out font-size-13 mrg5R"></i>
                            <span class="font-bold">导出全部</span>
                        </a>
                    </li>
                    <li class="hidden">
                        <a href="/cs/index.php/Admin/Faculty/outxls" target="checkedExport" idname="ids">
                            <i class="glyph-icon icon-sign-out font-size-13 mrg5R"></i>
    ...
    <table class="table text-left"  id="zstable">
        ...
        <tbody>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td class="text-center"><input type="checkbox" name="ids" class="j-icheck" value="<?php echo ($vo['id']); ?>">
                </td>
				<td>
                    <a href="<?php echo U('edit',array('id'=>$vo['id']));?>" rel="facultyedit<?php echo ($vo['id']); ?>" class="btn bg-blue small" target="dialog" width="500px" height="280px" ><span class="button-content"><i class="glyph-icon icon-edit"></i> 编辑</span></a>
