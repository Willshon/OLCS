                ...
                <i class="glyph-icon icon-star-o"></i> 取消推荐与置顶
                         ...
                         <div class="dropdown float-right mrg15R">
                                ...
                                <ul class="dropdown-menu float-right">
                                     ...
                                     <li class="hidden">
                                        <a href="/cs/index.php/Admin/Article/outxls/ids/all" target="dwzExport">
                                            <i class="glyph-icon icon-sign-out font-size-13 mrg5R"></i>
                                            <span class="font-bold">导出全部</span>
                                        </a>
                                    </li>
                                     <li class="hidden">
                                        <a href="/cs/index.php/Admin/Article/outxls" target="checkedExport" idname="ids">
                                            <i class="glyph-icon icon-sign-out font-size-13 mrg5R"></i>
  ...
  <table class="table text-left"  id="zstable">
        ...
        <tbody>
           <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td><a href="<?php echo U('Home/Index/artc',array('id'=>$vo['id']));?>" target="_blank"><?php echo ($vo["title"]); ?></a></td>
