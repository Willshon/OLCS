    ...
    <form action="<?php echo U('index');?>" method="post" id="formsearch">
        ...
        <label>标签名称：</label>
                ...
                <div class="form-input col-md-2">
                    <input type="text" value="<?php echo ($_REQUEST["title"]); ?>" name="title" size="13" />
                </div>
         ...
         <button type="submit" class="btn medium bg-orange"> <span class="button-content">
          ...
          <div class="dropdown float-right mrg15R">
                                ...
                                <ul class="dropdown-menu float-right">
                                     ...
                                     <li class="hidden">
                                        <a href="/cs/index.php/Admin/Tags/outxls/ids/all" target="dwzExport">
                                            <i class="glyph-icon icon-sign-out font-size-13 mrg5R"></i>
                                            <span class="font-bold">导出全部</span>
                                        </a>
                                    </li>
                                     <li class="hidden">
                                        <a href="/cs/index.php/Admin/Tags/outxls" target="checkedExport" idname="ids">
                                            <i class="glyph-icon icon-sign-out font-size-13 mrg5R"></i>
   ...
   <table class="table text-left"  id="zstable">
        <thead>
            <tr>
                ...
                <th class="nosort text-center" width="160">操作</th>
            </tr>
        </thead>
        <tbody>
           ...
           <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <a href="<?php echo U('edit',array('id'=>$vo['id']));?>" title="<?php echo ($vo['title']); ?>编辑" target="dialog"  width="530px" height="440px"  class="btn small bg-blue"   ><span class="button-content"><i class="glyph-icon icon-edit"></i> 编辑</span></a>
