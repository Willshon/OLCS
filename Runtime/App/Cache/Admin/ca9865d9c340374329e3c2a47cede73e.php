...
<div class="example-code">
  <div class="form-label float-left" >
                ...
                <div class="form-input col-md-2">
                    <input  type="text" name="no" value="<?php echo ($_REQUEST['no']); ?>">
                </div>
                ...
                <i class="glyph-icon icon-plus"></i> 新增
                            ...
                            <div class="dropdown float-right mrg15R">
                                ...
                                <ul class="dropdown-menu float-right">
                                     ...
                                     <li class="hidden">
                                        <a href="/cs/index.php/Admin/Student/outxls/ids/all" target="dwzExport">
                                            <i class="glyph-icon icon-sign-out font-size-13 mrg5R"></i>
                                            <span class="font-bold">导出全部</span>
                                        </a>
                                    </li>
                                     <li class="hidden">
                                        <a href="/cs/index.php/Admin/Student/outxls" target="checkedExport" idname="ids">
                                            <i class="glyph-icon icon-sign-out font-size-13 mrg5R"></i>
    ...
    <table class="table text-left"  id="zstable">
        ...
        <tbody>
           ...
           <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td><?php echo ($vo['rxsj']); ?></td>
				<td><?php echo ($vo['bysj']); ?></td>
                ...
                <td>
                <div class="mrg0A">
                 <a href="<?php echo U('edit',array('id'=>$vo['id']));?>" rel="editstudent<?php echo ($vo['id']); ?>"   class="btn small bg-blue" target="dialog"  width="440px" height="400px" ><span class="button-content"><i class="glyph-icon icon-edit"></i> 编辑</span></a>
