...
INSERT INTO `cs_syslogs` VALUES

('1', '系统管理', '系统安装', '添加管理员', '成功', '1', '管理员', '127.0.0.1', '1373024066');
...
(24, 'NICK_NAME_BAOLIU', 1, '保留昵称', 3, '', '禁止注册昵称,用" , "号隔开', 1388845937, 1388845937, 1, 'admin,管理员,user,用户,test,测试', 0),
(52, 'USER_NAME_BAOLIU', 1, '保留用户名', 3, '', '禁止注册用户名,用" , "号隔开', 1388845937, 1388845937, 1, 'admin,管理员,user,用户,test,测试', 0),
...
(511, 'foreverdelete', '删除', 1, ' ', 0, 500, 3, 0, 0, ''),
...
(518, 'foreverdelete', '删除', 1, ' ', 0, 501, 3, 0, 0, ''),
...
(538, 'foreverdelete', '删除', 1, ' ', 0, 504, 3, 0, 0, ''),
...
(545, 'foreverdelete', '删除', 1, ' ', 0, 505, 3, 0, 0, ''),
...
(4, '教师', 0, 1, '教师用户', NULL, 1423969187, 1423969187);
...
INSERT INTO `cs_role_user` (`role_id`, `user_id`) VALUES
(1, '1'),
...
INSERT INTO `cs_score` (`id`, `stuid`, `couid`, `score`) VALUES
(1, 1, 1, 2);
...
INSERT INTO `cs_student` (`id`, `no`, `name`, `pwd`, `subid`, `fudaoyuan`, `rxsj`, `bysj`, `status`) VALUES
(1, '6111010113', '王硕', '123456', 1, '王琳', '2011年9月', '2015年6月', 1);
...
(2, NULL, '路晓亚', '女', 19780101, '中共党员', NULL, NULL, NULL, '本科', '学士', '讲师', NULL, 1, 1);
